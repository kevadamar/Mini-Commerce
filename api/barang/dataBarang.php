<?php 
    ...
    if (empty($qparam)) {
       ...
       $query = "SELECT fb.id_barang,fb.id_kategori,fb.id_satuan,fb.harga,fb.image,fb.nama_barang,fb.tglexpired,fpd.qty,fp.tgl_penjualan FROM flutter_barang fb INNER JOIN flutter_penjualan_detail fpd ON fpd.id_barang = fb.id_barang INNER JOIN flutter_penjualan fp ON fp.id_faktur = fpd.id_faktur ORDER BY fpd.qty DESC,fp.tgl_penjualan DESC";
